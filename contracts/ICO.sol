...
contract ICO is Ownable {
    ...
    constructor(address tokenAddress) {
        ...
        require(_token.balanceOf(_token.owner()) == 1000000 * 10**18, "ICO: The owner must have token ROT for exchange");
    ...
    /// @dev Use to buy RoToken whith Ether
    ...
    /// @dev ICO is finished
    /// @return Time left before the end ICO RoToken
